...
class ChelonaValidationSpec extends AnyFlatSpec {
  ...
  "The input file ./TurtleTests/turtle-syntax-bad-prefix-01.ttl" must "fail" taggedAs (TestTurtleNegativeSyntax, TurtleSyntaxBad) ignore {
  ...
  //FIXME this test should not be ignored
  "The input file ./TurtleTests/turtle-syntax-bad-prefix-02.ttl" must "fail" taggedAs (TestTurtleNegativeSyntax, TurtleSyntaxBad) ignore {
